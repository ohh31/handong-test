        ...
        >
          <div className="question-main-container">
            ...
            <button
              ...
              id={qstDataSet[data].type + "-ans1"}
              onClick={
                qstDataSet.length - 1 === data
                  ? handleOnSubmit
                  : handleInputChange
              }
            >
              {changeNullToBr(qstDataSet[data].ans1)}
            </button>
            <button
              id={qstDataSet[data].type + "-ans2"}
              className="select-btn"
              onClick={
                qstDataSet.length - 1 === data
                  ? handleOnSubmit
            ...
            >
              {changeNullToBr(qstDataSet[data].ans2)}
            </button>
          </div>
        </CSSTransition>
      </div>
